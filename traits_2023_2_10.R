...
prp(rev_1m_5var_prune, type = 3, box.palette = "auto", legend.x=NA, legend.y=NA,  under = T, tweak = 1.2, varlen = 0, faclen = 0, Margin = 0.0, digits = -2, main='Revolved during last month: Classification tree', extra=100)#faclet=0 avoids abbreviations, tweak for char size. I remove extra = 100 to remove percentage of observations.
