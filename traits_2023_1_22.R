...
## Classification tree revolved last 1 month
# run rpart
set.seed(1955)# to be able to reproduce the rpart CV below
...
## Classification tree: cc_adopt [synthetic dataset] 
# run rpart
set.seed(1955)# to be able to reproduce the rpart CV below
...
## Classification tree: unbanked [original non-syn dataset] 
# run rpart
set.seed(1955)# to be able to reproduce the rpart CV below
...
## Classification tree: unbanked [synthetic dataset] 
# run rpart
set.seed(1955)# to be able to reproduce the rpart CV below
